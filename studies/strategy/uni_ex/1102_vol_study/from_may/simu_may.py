...
for data_cat, df_cur in [("test", df_te)]:
    ...
    if data_cat == "train":
        print(f"Train profit rate per year: {profit_rate_per_year * 12 / 4}")
    elif data_cat == "test":
        print(f"Test profit rate per year: {profit_rate_per_year * 12 / 4}")
