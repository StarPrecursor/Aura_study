...
use_strategy = ar_ana.strategies.ChampagneTower
...
for fut in [1, 3, 5, 10, 15, 21, 30, 45]:
    ...
    # Config
    model_config_path = (
        Path("/home/yangzhe/Aura_study/model/fr_pred/1108_fut_n_eff")
    ...
    for hl in [0, 8, 16, 24, 48, 72]:
        ...
        for data_cat, df_cur in [("train", df_tr), ("test", df_te)]:
            ...
            feature_map = {
                ...
                "vol": "vol",
                "signal": "signal",
                "signal_true": f"funding_rate_trade__future_{fut}_eff",
            }
            if hl == -1:
